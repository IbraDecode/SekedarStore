...
export function CatLottie({
  ...
  const autoLoop = loop ?? ['successLove', 'successCheck'].includes(variant) ? false : true;

  return (
    <div className={clsx('flex items-center justify-center', className)} style={{ background: 'transparent' }}>
      <DotLottieReact
